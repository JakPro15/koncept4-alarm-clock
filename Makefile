...
export GLOBAL_CFLAGS=-O3 -flto -fuse-linker-plugin -Wall -Wextra -Wpedantic -Werror -fanalyzer -Wno-stringop-overflow -Wno-analyzer-use-of-uninitialized-value -Wno-analyzer-malloc-leak
